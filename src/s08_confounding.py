...
def synthetic_control(df, albums=None, window=10, pre_periods=10, post_periods=5):
    ...
    print(f"{'='*70}")
    print("Building synthetic counterfactual for each release using")
    ...
    for _, r in results_df.iterrows():
        print(
            ...
            f"{r['actual']:>8.0f} | {r['synthetic']:>8.1f} | "
            f"{r['effect']:>+10.1f} | {r['pre_match_mse']:>8.1f}"
        )
    ...
    if placebo_effects:
        ...
        print("  Placebo effect distribution:")
