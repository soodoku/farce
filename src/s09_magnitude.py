...
def power_analysis(df_global, n_albums=10, alpha=0.05):
    ...
    print("    US baseline: ~100 deaths/day")
    print("    If weekly releases: 52 * 18 = ~936 extra deaths/year")
    print("    That's almost 1% of all traffic fatalities from album releases alone!")
