...
from src.constants import ALBUMS_EXTENDED, ALBUMS_TIER0, ALBUMS_TIER1, ALBUMS_TIER3
...
def main():
    ...
    gates.run_all(daily, window=args.window)
    ...
    save_table(friday_results, "tabs/t18_friday_placebo.md")
    print("Saved: tabs/t18_friday_placebo.md")

    cherry_results = cherry_pick_benchmark(df_global)
    save_table(cherry_results, "tabs/t18b_cherry_pick_benchmark.md")
    ...
    save_table(structural_results, "tabs/t28b_structural_fars_composition.md")
